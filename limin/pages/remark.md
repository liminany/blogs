...
- 画出项目关键时间线，让大家回忆开发过程中的事件，可以有好的和不好的,并收集上来，事件分为好的和不好的 【主要针对移动查验项目】
    1. .
    1.  画出时间线，一同讨论时间线，回忆之前的活动【20分钟】   【5-30至6-6，交付阶段，即客户试用阶段，重点是测试组和项目负责人】【5-20至5-26，重新设计UI，前端页面重新适配，功能性bug修复，重点是开发团队、设计师、前端】【4-25至5-20，PC端、移动APP、接口实现，重点是开发团队、设计师、前端、测试团队 】【4-5号至4-24，重点是数据库设计、原型设计、PC端框架搭建、移动端框架搭建】
    1. 	三人或四人一组,从结尾开始写，向前回溯各个时间线讨论当时的事件或活动，并记录下来 。提醒大家从多角度来思考，把认为重要的事情记录下来【约十分钟】【可分为做得好的方面、技术相关、管理相关、团队相关】
    
    1. 	采用三个五的方法收集，不大于五个人的小组，每个人花不超过五分钟的时间在纸上写下内容，然后传递给下一个组员，下一个组员在其基础上添加或补充其他内容，这样不超过五轮来收集内容 
    
    1.  完成后每人都阅读纸上的想法
    
    1.  组织讨论：讨论读到最突出的五件事是什么？哪五件事让你产生的反应和共鸣最强烈？最重要的五件事是什么？
    
    1.  汇总所有意见，重点关注开发实践层面的问题，记录下来用于下次改进。
     
    1.  不好的用5W法分析根本原因
    
    1.  汇总所有意见，可分为Keep 需保持的好的方面、正在改变的、Try需要偿试改变的

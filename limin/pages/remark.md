...
## 2016-06-01 回顾会议流程概要
-1. 会前工作，可以先做一些基础调查表，为促进成员的沟通，先要和管理层沟通保持低调，为保证全员参与，可以找一些平时比较活跃的托带动气氛。会议准备：打印签名表格、主持人引导文档、编写会议议程PPT并打印、通知参会人员带好手机和笔和纸。【计时人、会议纪要人、代理主持人、回顾会议基调监督人】
...
- 确定回顾基调和公约，设定奖罚规则，并安排人员监督 
	0. 匿名活动：的探索者游戏，将可选项展示出来，让大家选择交统计，可通过QQ群匿名发言或者纸张来实现【打开ESVP.png图片】
	...
	1. 一些常见的公约：手机调成静音、除非主持人要求大家使用手机否则不要玩手机、如果中途有客户电话先通知晚点在打过去、要求大家共同参与、不积极参与的人如何处理
   2. 让大家设定惩罚规则，如果违反需惩罚，惩罚可以是当大家的面做10个符合衬、或者给大家发个20的红包？等
   3. 安排监督人员，【有小福利，保蜜先，会后公布】
   4. 讨论中需要重点注意的：探询而不是辩护、对话、而不是争论、交流而不是争吵、理解而不是防备.四人一组，【公开活动：每组讨论一条原则，并派代表陈述小组的理解】   

- 画出项目关键时间线，让大家回忆开发过程中的事件，可以有好的和不好的,并收集上来，事件分为好的和不好的 【主要针对移动查验项目】
	1. 画出时间线，一同讨论时间线，回忆之前的活动【20分钟】
   2. 三人或四人一组,从结尾开始写，向前回溯各个时间线讨论当时的事件或活动，并记录下来 。提醒大家从多角度来思考，把认为重要的事情记录下来【约十分钟】【可分为做得好的方面、技术相关、管理相关、团队相关】
   3. 采用三个五的方法收集，不大于五个人的小组，每个人花不超过五分钟的时间在纸上写下内容，然后传递给下一个组员，下一个组员在其基础上添加或补充其他内容，这样不超过五轮来收集内容 
   4. 完成后每人都阅读纸上的想法
   5. 组织讨论：讨论读到最突出的五件事是什么？哪五件事让你产生的反应和共鸣最强烈？最重要的五件事是什么？
   6. 汇总所有意见，重点关注开发实践层面的问题，记录下来用于下次改进。
   7. 对不好的用5W法分析根本原因
   8. 汇总所有意见，可分为Keep 需保持的好的方面、正在改变的、Try需要偿试改变的
   9. 最后小结，哪些主题没有涉及到？哪一主题需要后续继续分析？记录下来并在下次继续讨论
